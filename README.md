...
In the terminal, navigate to the location where the project folder has to be created. Then enter the git command to clone the project:<br />`$ git clone https://github.com/sathish-ku-mar/Django-Assignment.git`<br />
Once cloned, change the directory to **Django-Assignment**<br />`$ cd Django-Assignment`
